export default function UsageInstructions() {
  return (
    <section className="mb-16 md:mb-24 bg-indigo-50/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-indigo-100">
      <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">How to Use <span className="text-indigo-600">Purrify™</span></h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="text-center bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-md border border-white/50">
          ...
          <h3 className="text-xl font-semibold mb-2 text-indigo-800">Clean the Litter</h3>
        ...
        <div className="text-center bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-md border border-white/50">
          ...
          <h3 className="text-xl font-semibold mb-2 text-indigo-800">Sprinkle Purrify</h3>
        ...
        <div className="text-center bg-white/70 backdrop-blur-sm p-6 rounded-xl shadow-md border border-white/50">
          ...
          <h3 className="text-xl font-semibold mb-2 text-indigo-800">Mix Lightly</h3>
