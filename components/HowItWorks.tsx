export default function HowItWorks() {
    return (
      <section id="how-it-works" className="mb-16 md:mb-24">
        <h2 className="text-3xl font-bold text-center mb-4 text-brand-secondary">
          The <span className="text-brand-primary">Purrify™</span> Difference
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-md card-hover border border-white/50">
            <div className="w-14 h-14 bg-brand-secondary text-white rounded-full flex items-center justify-center mb-4 mx-auto shadow-md">
              <i className="fas fa-atom text-xl"></i>
            </div>
            <h3 className="text-xl font-semibold mb-3 text-center text-brand-secondary-dark">Microporous Structure</h3>
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-md card-hover border border-white/50">
            ...
            <h3 className="text-xl font-semibold mb-3 text-center text-brand-secondary-dark">Adsorption Magic</h3>
            <p className="text-gray-700 text-center">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-md card-hover border border-white/50">
            ...
            <h3 className="text-xl font-semibold mb-3 text-center text-brand-secondary-dark">Ammonia Neutralizer</h3>
            <p className="text-gray-700 text-center">
